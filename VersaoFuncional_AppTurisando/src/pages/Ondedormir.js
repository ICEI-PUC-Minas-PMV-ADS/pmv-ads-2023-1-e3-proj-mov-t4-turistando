...
const navigation = useNavigation ();
 ...
 return(
   ...
   texto={'Situado num belo edifício colonial, o Hotel Solar Das Lajes fica numa área de floresta nativa e disponibiliza uma piscina exterior e uma mina de ouro aberta para visitas. A propriedade providencia estacionamento privado gratuito, um salão partilhado, um jardim e acesso Wi-Fi gratuito em todas as áreas.'}
   ...
   texto={'Localizada apenas a 150 metros da praia, a Pousada Por do Sol disponibiliza acesso Wi-Fi gratuito e um buffet de pequeno-almoço. A Duna Pôr do Sol também fica apenas a 150 metros.'}
